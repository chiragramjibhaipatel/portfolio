...
import {BlockStack, Button, Card, DropZone, InlineGrid, InlineStack, Spinner, Text} from "@shopify/polaris";

export function ClientImageUploader({imageUrl, handleSetImageUrl}: {
